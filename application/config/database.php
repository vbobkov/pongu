...
$db['california']['db_debug'] = TRUE;
$db['california']['cache_on'] = FALSE;
$db['california']['cachedir'] = '';
$db['california']['char_set'] = 'utf8';
$db['california']['dbcollat'] = 'utf8_general_ci';
...
$db['newcastle']['database'] = 'ponguncl';
